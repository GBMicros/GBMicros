...
if(NEXTCLOUD_DEV)
    ...
    set( APPLICATION_NAME       "GBMicros" )
    set( APPLICATION_SHORTNAME  "GBMicros" )
    set( APPLICATION_EXECUTABLE "gbmicros" )
    set( APPLICATION_ICON_NAME  "Nextcloud" )
endif()

set( APPLICATION_CONFIG_NAME "${APPLICATION_EXECUTABLE}" )
set( APPLICATION_DOMAIN     "gbmicros.co.uk" )
set( APPLICATION_VENDOR     "GBMicros" )
set( APPLICATION_UPDATE_URL "https://updates.nextcloud.org/client/" CACHE STRING "URL for updater" )
set( APPLICATION_HELP_URL   "" CACHE STRING "URL for the help menu" )

if(APPLE AND APPLICATION_NAME STREQUAL "GBMicros" AND EXISTS "${CMAKE_SOURCE_DIR}/theme/colored/Nextcloud-macOS-icon.svg")
    set( APPLICATION_ICON_NAME "Nextcloud-macOS" )
    message("Using macOS-specific application icon: ${APPLICATION_ICON_NAME}")
endif()

set( APPLICATION_ICON_SET   "SVG" )
set( APPLICATION_SERVER_URL "nextcloud.gbmicros.co.uk" CACHE STRING "URL for the server to use. If entered, the UI field will be pre-filled with it" )
set( APPLICATION_SERVER_URL_ENFORCE ON ) # If set and APPLICATION_SERVER_URL is defined, the server can only connect to the pre-defined URL
set( APPLICATION_REV_DOMAIN "uk.co.gbmicros.storage" )
set( DEVELOPMENT_TEAM "XG7B22RY35" CACHE STRING "Apple Development Team ID" )
set( APPLICATION_VIRTUALFILE_SUFFIX "gbmicros" CACHE STRING "Virtual file suffix (not including the .)")
